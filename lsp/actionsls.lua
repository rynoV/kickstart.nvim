-- From https://github.com/actions/languageservices/tree/main/languageserver#in-neovim
...
local function get_repo_info(owner, repo)
  local cmd = string.format("gh repo view %s/%s --json id,owner --template '{{.id}}\t{{.owner.type}}' 2>/dev/null", owner, repo)
...
-- :MasonInstall gh-actions-language-server
return {
